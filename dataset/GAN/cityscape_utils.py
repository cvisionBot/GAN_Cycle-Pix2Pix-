...
if __name__ == '__main__':
    ...
    parser.add_argument('--gtFine_dir', type=str, required=True, help='Path to the Cityscapes gtFine directory')
    parser.add_argument('--leftImg8bit_dir', type=str, required=True, help='Path to the leftImg8bit_trainvaltest directory')
    parser.add_argument('--output_dir', type=str, required=True, default='/mnt/citycapes', help='Directory the output images')
    opt = parser.parse_args()

    process_cityscapes(opt.gtFine_dir, opt.leftImg8bit_dir, opt.output_dir, "val") # validation dataset
    process_cityscapes(opt.gtFine_dir, opt.leftImg8bit_dir, opt.output_dir, "train") # train dataset
    print('Done')
